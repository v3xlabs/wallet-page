  ...
  return (
    <div className="flex grow flex-col pb-4">
      ...
      <div className="flex flex-col">
        {catalog.map((token) => {
          const isAlways = token.symbol === "ETH";
          ...
          return (
            ...
            >
              ...
              <span className="flex min-w-0 grow flex-col gap-px">
                ...
                <span className="text-xs text-muted">{isAlways ? "Always shown" : token.symbol}</span>
              </span>
              <CheckDot checked={isAlways || enabledSymbols.includes(token.symbol)} muted={isAlways} />
            </button>
          );
        })}
      </div>
